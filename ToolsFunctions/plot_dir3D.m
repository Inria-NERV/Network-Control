function [h1, h2] = plot_dir3D (vX, vY , vZ , myColor)
if nargin < 4
    myColor = 'r';
end
...
% make plot 
h1 = plot3(vX, vY , vZ, 'Color' , myColor , 'LineStyle' , '-'); hold on;
% add arrows 
h2 = quiver3(vXQ0,vYQ0, vZQ0, vPx, vPy,vPz , 0, myColor ,'LineWidth' , 2 );%'AutoScale' , 'off' , 'AutoScaleFactor' , 5);
grid on; hold off
axis equal
